  ...
  return (
    ...
    >
      <div className="container-custom">
        <AnimatedSection>
          <SectionHeading num="04" label="Race History" title="Experience & Organizations" />
        </AnimatedSection>
...
function TimelineCol({
  ...
  return (
    <AnimatedSection delay={0.1}>
      ...
      >
        <div className="tape-line" style={{ width: "1.5rem", height: "6px", flexShrink: 0 }} />
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", gap: "0" }}>
        ...
        {items.map((item, i) => {
          const startYear = item.period.split(/[–-]/)[0]?.trim() || item.period;
          return (
            <motion.div
              key={i}
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "0.25rem", marginBottom: "0.25rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    {item.image && (
                      <div style={{ width: "24px", height: "24px", overflow: "hidden", flexShrink: 0, position: "relative", background: "var(--bg-secondary)" }}>
                ...
                <p style={{ fontFamily: 'var(--font-ui)', fontSize: "clamp(0.6rem, 1.2vw, 0.72rem)", color: "var(--red-light)", marginBottom: "0.6rem", letterSpacing: "0.04em", fontWeight: 600 }}>
                  {item.org} · {item.location} · {item.period}
                </p>
                ...
                {item.impact && (
                  <div style={{ marginTop: "0.75rem", padding: "clamp(0.5rem, 1.5vw, 0.65rem)", background: "var(--red-dim)", borderLeft: "4px solid var(--red)", color: "var(--text-primary)", fontSize: "clamp(0.7rem, 1.2vw, 0.78rem)", lineHeight: 1.5 }}>
